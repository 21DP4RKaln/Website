                        ...
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                ...
                                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <button class="btn btn-primary mt-2">Update Profile Picture</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <span class="text-secondary">{{ $user->github_username }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0">
                            ...
                            <span class="text-secondary">{{ $user->twitter_username }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0">
                            ...
                            <span class="text-secondary">{{ $user->instagram_username }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0">
                            ...
                            <span class="text-secondary">{{ $user->facebook_username }}</span>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                <h6 class="d-flex align-items-center mb-3">
                                    <i class="material-icons text-info mr-2">Selling items</i>
                                </h6>
                                ...
                                @endforeach
                                <a href="{{ route('sellingItems.index') }}" class="btn btn-primary">See More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 mb-3">
                        <div class="card h-100">
                            <div class="card-body">
                                <h6 class="d-flex align-items-center mb-3">
                                    <i class="material-icons text-info mr-2">Wish list</i>
                                </h6>
                                ...
                                @endforeach
                                <a href="{{ route('wishList.index') }}" class="btn btn-primary">See More</a>
                            </div>
                        </div>
                    </div>
                </div>
