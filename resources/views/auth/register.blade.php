<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="w-full">
        ...
        <div class="step">
            ...
            <div class="mt-12">
                <button type="submit" class="w-full shadow-xl py-3.5 px-8 text-sm font-semibold rounded-xl bg-teal-500 hover:bg-teal-600 text-white border focus:outline-none transition-all" href="{{ route('home') }}">
