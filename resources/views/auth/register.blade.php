                ...
                <form method="POST" action="{{ route('register') }}" class="w-full">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center mb-6">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] absolute right-4" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" data-original="#000000"></path>
                                </svg>
                            </div>
                            <div class="input-group mb-6">
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] absolute right-4" viewBox="0 0 24 24">
                                            <path d="M12 12c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm0 2c-3.31 0-10 1.66-10 5v2h20v-2c0-3.34-6.69-5-10-5z" data-original="#000000"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div>
                    ...
                    <div class="step">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] absolute right-4" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" data-original="#000000"></path>
                                </svg>
                            </div>
                    ...
                    <div class="step">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center mb-6">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke-width="1.5" stroke="currentColor" class="w-[18px] h-[18px] absolute right-4" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" data-original="#000000"></path>
                                </svg>
                            </div>
                        </div>
                        <div class="mt-12">
                    ...
                    <div class="step">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input id="confirm_password" name="confirm_password" type="password" required class="w-full bg-transparent text-sm border-2 focus:border-teal-500 px-4 py-3.5 outline-none rounded-xl" placeholder="Confirm password" />
