...
<body>
    ...
    <div class="container">
        <div class="profile-header">
            ...
            <div class="flex items-center gap-4 hidden sm:flex">
                <a class="rounded-md bg-gray-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-700" href="{{ route('profile.edit') }}">
                    Edit Profile
                </a>
            </div>
        </div>
        ...
        <div class="selling-items">
            ...
            @foreach($user->sellingItems as $item)
        ...
        <div class="comments-section">
            ...
            <button class="rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700">Add Comment</button>
        </div>
